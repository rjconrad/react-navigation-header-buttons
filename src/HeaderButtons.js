...
export class HeaderButtons extends React.Component<HeaderButtonsProps> {
  ...
  render() {
    const { visibleButtons, hiddenButtons } = getVisibleAndHiddenButtons(
      this.props
    );
    const {
      OverflowIcon,
  ...
  getEdgeMargin() {
    return this.props.left
      ? styles.extraEdgeMarginOnLeft
      : styles.extraEdgeMarginOnRight;
  }

  renderVisibleButtons(
    visibleButtons: Array<React.Element<*>>
  ): Array<React.Element<*>> {
